...
def modificar_dados_filmes(filme):
    ...
    if resultado == "nome":
        modificacao = mn.modificar_dado(resultado=resultado)
        update.update_filmes(sett=resultado, set_value=modificacao, where="descricao", where_value=filme[2])
        return True

    elif resultado == "descricao":
        modificacao = mn.modificar_dado(resultado=resultado)
        update.update_filmes(sett=resultado, set_value=modificacao, where="nome", where_value=filme[1])
        return True
